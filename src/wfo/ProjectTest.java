...
//		double[] arr = c.getClose();
//		double[] arr1 = Indicators.rsi(arr, 10);
...
//		b.stringOut(0);
//		c.stringOut(0);
//		a.stringOut(a.getDate().length - 1);
//		b.stringOut(b.getDate().length - 1);
//		c.stringOut(c.getDate().length - 1);
//		double[] rsi = new double[] {5.2, 7.3, 8.3, 7.1, 9.2};
//		//double[] arr = new double[] {};
//		Indicators arr = new Indicators();
//		arr.rsi(rsi, 2);
//		rsi = arr.getRsi();
//		for (double i : rsi) {
//			System.out.println(i);
