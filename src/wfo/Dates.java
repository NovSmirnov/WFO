...
//        LocalDate b = convertDate(date).minusDays(days);
    ...
    public static int dayOfWeek(int date) {
            LocalDate dDate = convertDate(date);
            DayOfWeek day = dDate.getDayOfWeek();
            return day.getValue();
    }

    public static LocalDate convertDate(int date) {
            String str = String.valueOf(date);
            String yyyy = str.substring(0, 4);
            String mm = str.substring(4, 6);
            String dd = str.substring(6, 8);
            ...
            int imm = Integer.parseInt(mm);
            int idd = Integer.parseInt(dd);
            return LocalDate.of(iyyyy, imm, idd);
    }
}
